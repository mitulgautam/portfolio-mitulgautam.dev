            ...
            <div className="container flex h-16 max-w-screen-xl items-center justify-between mx-auto px-4">
                ...
                <nav className="flex items-center gap-6">
                    <div className="hidden md:flex items-center gap-6 text-sm font-medium">
                        <Link href="#experience" className="transition-colors hover:text-foreground/80 text-foreground/60 retro:text-foreground retro:hover:text-primary retro:underline">
                            Experience
                        </Link>
                        <Link href="#projects" className="transition-colors hover:text-foreground/80 text-foreground/60 retro:text-foreground retro:hover:text-primary retro:underline">
                            Projects
                        </Link>
                        <Link href="#skills" className="transition-colors hover:text-foreground/80 text-foreground/60 retro:text-foreground retro:hover:text-primary retro:underline">
                            Skills
                        </Link>
                    </div>
                    <ThemeToggle />
